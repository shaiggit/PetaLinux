...
/*##################################################################### */
    ...
    *  PSU_CRL_APB_RPLL_CTRL_FBDIV                                 0x20
    ...
    * PLL Basic Control
    * (OFFSET, MASK, VALUE)      (0XFF5E0030, 0x00717F00U ,0x00012000U)
    */
	PSU_Mask_Write(CRL_APB_RPLL_CTRL_OFFSET, 0x00717F00U, 0x00012000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_QSPI_REF_CTRL_DIVISOR1                          0x4
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0068, 0x013F3F07U ,0x01040500U)
    */
	PSU_Mask_Write(CRL_APB_QSPI_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01040500U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (Trace Port Clock)
    *  PSU_IOU_SLCR_MIO_PIN_38_L3_SEL                              3

    * Configures MIO Pin 38 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180098, 0x000000FEU ,0x00000060U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_38_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
    ...
    * Control Signal)
    *  PSU_IOU_SLCR_MIO_PIN_39_L3_SEL                              3

    * Configures MIO Pin 39 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18009C, 0x000000FEU ,0x00000060U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_39_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_40_L3_SEL                              3

    * Configures MIO Pin 40 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800A0, 0x000000FEU ,0x00000060U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_40_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_41_L3_SEL                              3

    * Configures MIO Pin 41 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800A4, 0x000000FEU ,0x00000060U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_41_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  Not Used
    *  PSU_IOU_SLCR_MIO_PIN_44_L3_SEL                              2

    * Configures MIO Pin 44 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800B0, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_44_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_45_L3_SEL                              2

    * Configures MIO Pin 45 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800B4, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_45_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_72_L3_SEL                              6

    * Configures MIO Pin 72 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180120, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_72_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_73_L3_SEL                              6

    * Configures MIO Pin 73 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180124, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_73_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x01000000U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0xFC0006C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0xFC0006C0U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18020C, 0x00003FFFU ,0x00000200U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI2_OFFSET,
		0x00003FFFU, 0x00000200U);
/*##################################################################### */
